...
module dma_mem_mm_traffic_generator #(
		...
		parameter TG_SEQ_ADDR_GEN_MAX_BURSTCOUNT         = 256,
		parameter TG_RAND_ADDR_GEN_MIN_BURSTCOUNT        = 1,
		parameter TG_RAND_ADDR_GEN_MAX_BURSTCOUNT        = 256,
		parameter TG_RAND_SEQ_ADDR_GEN_MIN_BURSTCOUNT    = 1,
		parameter TG_RAND_SEQ_ADDR_GEN_MAX_BURSTCOUNT    = 256,
		...
		output wire [8:0]   avl_size,        //          .burstcount
		output wire [255:0] avl_wdata,       //          .writedata
		input  wire [255:0] avl_rdata,       //          .readdata
		output wire         avl_write_req,   //          .write
		output wire         avl_read_req,    //          .read
		input  wire         avl_rdata_valid, //          .readdatavalid
		output wire [31:0]  avl_be,           //          .byteenable
		output [31:0]	count,
		output led,
		input start
	);
	...
	generate
		...
		if (DRIVER_SIGNATURE != 1431634061)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (TG_SEQ_ADDR_GEN_MAX_BURSTCOUNT != 256)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (TG_RAND_ADDR_GEN_MAX_BURSTCOUNT != 256)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
		...
		if (TG_RAND_SEQ_ADDR_GEN_MAX_BURSTCOUNT != 256)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
	...
	driver_avl_use_be #(
		...
		.TG_SEQ_ADDR_GEN_MAX_BURSTCOUNT         (256),
		.TG_RAND_ADDR_GEN_MIN_BURSTCOUNT        (1),
		.TG_RAND_ADDR_GEN_MAX_BURSTCOUNT        (256),
		.TG_RAND_SEQ_ADDR_GEN_MIN_BURSTCOUNT    (1),
		.TG_RAND_SEQ_ADDR_GEN_MAX_BURSTCOUNT    (256),
