...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_c0.v"                                       -work c0    -cdslib ./cds_libs/c0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0.v"                                       -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ...
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_irq_mapper.sv"                           -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0.v"                     -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_demux.sv"          -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_demux_001.sv"      -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_mux.sv"            -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_mux_003.sv"        -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router.sv"             -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_001.sv"         -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_002.sv"         -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_005.sv"         -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_demux_003.sv"      -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_mux.sv"            -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_mux_001.sv"        -work s0    -cdslib ./cds_libs/s0.cds.lib   
  ...
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_clock_pair_generator.v"                  -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_read_valid_selector.v"                   -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_addr_cmd_datapath.v"                     -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_reset.v"                                 -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_acv_ldc.v"                               -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_memphy.sv"                               -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_reset_sync.v"                            -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_new_io_pads.v"                           -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_fr_cycle_shifter.v"                      -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_fr_cycle_extender.v"                     -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_read_datapath.sv"                        -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_write_datapath.v"                        -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_core_shadow_registers.sv"                -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_simple_ddio_out.sv"                      -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_phy_csr.sv"                              -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_iss_probe.v"                             -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_addr_cmd_pads.v"                         -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_flop_mem.v"                              -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0.sv"                                      -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_altdqdqs.v"                              -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/altdq_dqs2_acv_cyclonev.sv"                               -work p0    -cdslib ./cds_libs/p0.cds.lib   
  ncvlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_pll0.sv"                                    -work pll0  -cdslib ./cds_libs/pll0.cds.lib 
  ncvlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram.v"                                          -work sdram -cdslib ./cds_libs/sdram.cds.lib
  ncvlog                                        "$QSYS_SIMDIR/dma_mem.v"                                                                                                       
fi
