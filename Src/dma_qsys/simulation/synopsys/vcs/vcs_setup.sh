...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/dma_mem_sdram_c0.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0.v \
  ...
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_irq_mapper.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_demux.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_demux_001.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_mux_003.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_001.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_002.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_005.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_demux_003.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_mux_001.sv \
  ...
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_clock_pair_generator.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_read_valid_selector.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_addr_cmd_datapath.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_reset.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_acv_ldc.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_memphy.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_reset_sync.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_new_io_pads.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_fr_cycle_shifter.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_fr_cycle_extender.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_read_datapath.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_write_datapath.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_core_shadow_registers.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_simple_ddio_out.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_phy_csr.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_iss_probe.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_addr_cmd_pads.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_flop_mem.v \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_p0_altdqdqs.v \
  $QSYS_SIMDIR/submodules/altdq_dqs2_acv_cyclonev.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram_pll0.sv \
  $QSYS_SIMDIR/submodules/dma_mem_sdram.v \
  $QSYS_SIMDIR/dma_mem.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
