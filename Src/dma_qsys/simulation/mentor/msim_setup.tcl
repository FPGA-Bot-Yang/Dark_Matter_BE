...
alias com {
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_irq_mapper.sv"                           -work s0   
  vlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0.v"                     -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_demux.sv"          -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_demux_001.sv"      -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_mux.sv"            -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_cmd_mux_003.sv"        -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router.sv"             -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_001.sv"         -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_002.sv"         -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_router_005.sv"         -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_demux_003.sv"      -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_mux.sv"            -work s0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_s0_mm_interconnect_0_rsp_mux_001.sv"        -work s0   
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_memphy.sv"                               -work p0   
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_read_datapath.sv"                        -work p0   
  vlog                                        "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_write_datapath.v"                        -work p0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_core_shadow_registers.sv"                -work p0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_simple_ddio_out.sv"                      -work p0   
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0_phy_csr.sv"                              -work p0   
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_p0.sv"                                      -work p0   
  ...
  vlog -sv                                    "$QSYS_SIMDIR/submodules/dma_mem_sdram_pll0.sv"                                    -work pll0 
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L a0 -L ng0 -L dll0 -L oct0 -L c0 -L s0 -L m0 -L p0 -L pll0 -L sdram -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L a0 -L ng0 -L dll0 -L oct0 -L c0 -L s0 -L m0 -L p0 -L pll0 -L sdram -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
